...
PAGES = [
  ...
  ("pricing",  "Horreum pricing", "Contact us for pricing. Tell us a little about your program and we’ll be in touch.", pages_a.PRICING, "website", None, False),
  ("about",    "About Horreum", "Horreum is independent reserve and locker management software for restaurants, clubs and wine bars, founded by Gabriel Collins. HORREUM LLC, Grand Rapids, Michigan.", pages_b.ABOUT, "website", None, False),
  ("contact",  "Contact Horreum — request a demo", "A thirty-minute walkthrough with the person who built it.", pages_b.CONTACT, "website", None, False),
